    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-XAPZQN4P.js"), import("./pbr.fragment-JYDTZ44N.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-7IHS265H.js"), import("./pbr.fragment-3XFUFGQQ.js")]);
        }
...
//# sourceMappingURL=chunk-GKDDWRXM.js.map
