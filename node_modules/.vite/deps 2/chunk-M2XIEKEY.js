...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-Z4IF5UQD.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-TBQK4LQU.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-MA5VS5L2.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-NDBCFKX2.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-DA7Z6VSZ.js");
...
//# sourceMappingURL=chunk-M2XIEKEY.js.map
