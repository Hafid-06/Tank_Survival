    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-QQV7GN4A.js"), import("./openpbr.fragment-B42MWVJK.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-PHNVQK4Y.js"), import("./openpbr.fragment-KEJHICHW.js")]);
        }
...
//# sourceMappingURL=chunk-HO24AA7J.js.map
