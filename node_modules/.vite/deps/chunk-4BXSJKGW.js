    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-XQDAXPYU.js"), import("./openpbr.fragment-6C4CSO4R.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-6IWTOSSY.js"), import("./openpbr.fragment-PSRRHEBV.js")]);
        }
...
//# sourceMappingURL=chunk-4BXSJKGW.js.map
