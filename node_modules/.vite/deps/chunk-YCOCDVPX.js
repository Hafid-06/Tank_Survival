import {
  ShadowLight
} from "./chunk-OQMCQRXF.js";
import {
  FlowGraphCoordinator
} from "./chunk-HWBXBJH6.js";
import {
  FlowGraphEventBlock
} from "./chunk-OILLWUDW.js";
import {
  FlowGraphExecutionBlock
} from "./chunk-IIBUOSSV.js";
import {
  RichType,
  defaultValueParseFunction,
  getRichTypeByFlowGraphType,
  needsPathConverter
} from "./chunk-C52HE5O7.js";
import {
  _UpdateRGBDAsync
} from "./chunk-B2UCPW3Z.js";
import {
  AutoReleaseWorkerPool
} from "./chunk-QCIHLJPD.js";
import {
  ToHalfFloat
} from "./chunk-LP4TW7QT.js";
import {
  Camera,
  Geometry,
  ImportMeshAsync,
  ...
  ShaderMaterial,
  StandardMaterial
} from "./chunk-W7YFBYF2.js";
import {
  Light
} from "./chunk-MGLWP3QA.js";
import {
  MaterialDefines,
  PushMaterial
} from "./chunk-TZF6ZLQC.js";
import {
  AbstractMesh,
  TransformNode,
  VertexData,
  ...
  runCoroutineAsync,
  runCoroutineSync
} from "./chunk-FF3RZHZ4.js";
import {
  BoundingInfo,
  SubMesh
} from "./chunk-C5O2VL6C.js";
import {
...
} from "./chunk-UJ6XYFEF.js";
import {
  Axis
} from "./chunk-RDCFBMGJ.js";
import {
  BaseTexture,
  Texture
} from "./chunk-LVQ4NMDH.js";
import {
  DrawWrapper
} from "./chunk-PJFTQINF.js";
import {
  Bone
} from "./chunk-6TH73K6I.js";
import {
  Animation,
  AnimationRange
} from "./chunk-EFXGIJJ4.js";
import {
  Node
} from "./chunk-YUKCXLEI.js";
import {
  EventConstants,
  KeyboardEventTypes
} from "./chunk-25RMDZYX.js";
import {
  PointerEventTypes
} from "./chunk-GDN55HFK.js";
import {
  PickingInfo
} from "./chunk-WZAGFHAL.js";
import {
  SmartArray
} from "./chunk-R2BDVQIE.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-YVOULDEP.js";
import {
  Color3,
  Color4
...
Mesh._instancedMeshFactory = (name5, mesh) => {
  const instance = new InstancedMesh(name5, mesh);
...
var InstancedMesh = class extends AbstractMesh {
   ...
   */
  constructor(name5, source) {
    super(name5, source.getScene());
   ...
   */
  createInstance(name5) {
    return this._sourceMesh.createInstance(name5);
  }
  /**
   ...
   * @returns the clone
   */
  clone(name5, newParent = null, doNotCloneChildren, newSourceMesh) {
    const result = (newSourceMesh || this._sourceMesh).createInstance(name5);
...
var AssetContainer = class extends AbstractAssetContainer {
  ...
  mergeAnimationsTo(scene = EngineStore.LastCreatedScene, animatables, targetConverter = null) {
    ...
    const _targetConverter = targetConverter ? targetConverter : (target) => {
      ...
      const name5 = target.name.split(".").join("").split("_primitive")[0];
      switch (targetProperty) {
        case "position":
        case "rotationQuaternion":
          node = scene.getTransformNodeByName(target.name) || scene.getTransformNodeByName(name5);
          break;
        case "influence":
          node = scene.getMorphTargetByName(target.name) || scene.getMorphTargetByName(name5);
          break;
        default:
          node = scene.getNodeByName(target.name) || scene.getNodeByName(name5);
      }
      return node;
    };
...
var Skeleton = class _Skeleton {
   ...
   */
  getBoneIndexByName(name5) {
    for (let boneIndex = 0, cache = this.bones.length; boneIndex < cache; boneIndex++) {
      if (this.bones[boneIndex].name === name5) {
        return boneIndex;
      }
    }
    return -1;
   ...
   */
  deleteAnimationRange(name5, deleteFrames = true) {
    for (let i = 0, nBones = this.bones.length; i < nBones; i++) {
      if (this.bones[i].animations[0]) {
        this.bones[i].animations[0].deleteRange(name5, deleteFrames);
      }
    }
   ...
   */
  getAnimationRange(name5) {
    return this._ranges[name5] || null;
  }
  /**
  ...
  getAnimationRanges() {
    ...
    let name5;
    for (name5 in this._ranges) {
      animationRanges.push(this._ranges[name5]);
    }
   ...
   */
  copyAnimationRange(source, name5, rescaleAsRequired = false) {
    if (this._ranges[name5] || !source.getAnimationRange(name5)) {
      return false;
    }
    let ret = true;
    ...
    for (i = 0, nBones = this.bones.length; i < nBones; i++) {
      ...
      if (sourceBone) {
        ret = ret && this.bones[i].copyAnimationRange(sourceBone, name5, frameOffset, rescaleAsRequired, skelDimensionsRatio);
      } else {
        Logger.Warn("copyAnimationRange: not same rig, missing source bone " + boneName);
        ret = false;
      }
    }
    const range = source.getAnimationRange(name5);
    if (range) {
      this._ranges[name5] = new AnimationRange(name5, range.from + frameOffset, range.to + frameOffset);
    }
    return ret;
  }
  /**
   ...
   */
  beginAnimation(name5, loop, speedRatio, onAnimationEnd) {
    const range = this.getAnimationRange(name5);
    if (!range) {
      return null;
    }
   ...
   */
  clone(name5, id) {
    const result = new _Skeleton(name5, id || name5, this._scene);
...
Node.AddNodeConstructor("TargetCamera", (name5, scene) => {
  return () => new TargetCamera(name5, Vector3.Zero(), scene);
});
...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-FOG4UOZ3.js")).FlowGraphPlayAnimationBlock;
    case "FlowGraphStopAnimationBlock":
      return async () => (await import("./flowGraphStopAnimationBlock-4KUHFPEC.js")).FlowGraphStopAnimationBlock;
    case "FlowGraphPauseAnimationBlock":
      return async () => (await import("./flowGraphPauseAnimationBlock-GRHA2JH4.js")).FlowGraphPauseAnimationBlock;
    case "FlowGraphInterpolationBlock":
      return async () => (await import("./flowGraphInterpolationBlock-D5DPY5IU.js")).FlowGraphInterpolationBlock;
    case "FlowGraphSceneReadyEventBlock":
      return async () => (await import("./flowGraphSceneReadyEventBlock-X27PXVVC.js")).FlowGraphSceneReadyEventBlock;
    case "FlowGraphSceneTickEventBlock":
      return async () => (await import("./flowGraphSceneTickEventBlock-6ROLHEEG.js")).FlowGraphSceneTickEventBlock;
    case "FlowGraphSendCustomEventBlock":
      return async () => (await import("./flowGraphSendCustomEventBlock-DNTX37NJ.js")).FlowGraphSendCustomEventBlock;
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-BVK4GT5L.js")).FlowGraphReceiveCustomEventBlock;
    case "FlowGraphMeshPickEventBlock":
      return async () => (await import("./flowGraphMeshPickEventBlock-GPZT3WE3.js")).FlowGraphMeshPickEventBlock;
    case "FlowGraphEBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphEBlock;
    case "FlowGraphPIBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphPiBlock;
    case "FlowGraphInfBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphInfBlock;
    case "FlowGraphNaNBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphNaNBlock;
    case "FlowGraphRandomBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphRandomBlock;
    case "FlowGraphAddBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAddBlock;
    case "FlowGraphSubtractBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSubtractBlock;
    case "FlowGraphMultiplyBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphMultiplyBlock;
    case "FlowGraphDivideBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphDivideBlock;
    case "FlowGraphAbsBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAbsBlock;
    case "FlowGraphSignBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSignBlock;
    case "FlowGraphTruncBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphTruncBlock;
    case "FlowGraphFloorBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphFloorBlock;
    case "FlowGraphCeilBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphCeilBlock;
    case "FlowGraphRoundBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphRoundBlock;
    case "FlowGraphFractBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphFractionBlock;
    case "FlowGraphNegationBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphNegationBlock;
    case "FlowGraphModuloBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphModuloBlock;
    case "FlowGraphMinBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphMinBlock;
    case "FlowGraphMaxBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphMaxBlock;
    case "FlowGraphClampBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphClampBlock;
    case "FlowGraphSaturateBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSaturateBlock;
    case "FlowGraphMathInterpolationBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphMathInterpolationBlock;
    case "FlowGraphEqualityBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphEqualityBlock;
    case "FlowGraphLessThanBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLessThanBlock;
    case "FlowGraphLessThanOrEqualBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLessThanOrEqualBlock;
    case "FlowGraphGreaterThanBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphGreaterThanBlock;
    case "FlowGraphGreaterThanOrEqualBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphGreaterThanOrEqualBlock;
    case "FlowGraphIsNaNBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphIsNanBlock;
    case "FlowGraphIsInfBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphIsInfinityBlock;
    case "FlowGraphDegToRadBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphDegToRadBlock;
    case "FlowGraphRadToDegBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphRadToDegBlock;
    case "FlowGraphSinBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSinBlock;
    case "FlowGraphCosBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphCosBlock;
    case "FlowGraphTanBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphTanBlock;
    case "FlowGraphASinBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAsinBlock;
    case "FlowGraphACosBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAcosBlock;
    case "FlowGraphATanBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAtanBlock;
    case "FlowGraphATan2Block":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAtan2Block;
    case "FlowGraphSinhBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSinhBlock;
    case "FlowGraphCoshBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphCoshBlock;
    case "FlowGraphTanhBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphTanhBlock;
    case "FlowGraphASinhBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAsinhBlock;
    case "FlowGraphACoshBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAcoshBlock;
    case "FlowGraphATanhBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphAtanhBlock;
    case "FlowGraphExponentialBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphExpBlock;
    case "FlowGraphLogBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLogBlock;
    case "FlowGraphLog2Block":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLog2Block;
    case "FlowGraphLog10Block":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLog10Block;
    case "FlowGraphSquareRootBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphSquareRootBlock;
    case "FlowGraphPowerBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphPowerBlock;
    case "FlowGraphCubeRootBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphCubeRootBlock;
    case "FlowGraphBitwiseAndBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseAndBlock;
    case "FlowGraphBitwiseOrBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseOrBlock;
    case "FlowGraphBitwiseNotBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseNotBlock;
    case "FlowGraphBitwiseXorBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseXorBlock;
    case "FlowGraphBitwiseLeftShiftBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseLeftShiftBlock;
    case "FlowGraphBitwiseRightShiftBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphBitwiseRightShiftBlock;
    case "FlowGraphLengthBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphLengthBlock;
    case "FlowGraphNormalizeBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphNormalizeBlock;
    case "FlowGraphDotBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphDotBlock;
    case "FlowGraphCrossBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphCrossBlock;
    case "FlowGraphRotate2DBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphRotate2DBlock;
    case "FlowGraphRotate3DBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphRotate3DBlock;
    case "FlowGraphTransposeBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphTransposeBlock;
    case "FlowGraphDeterminantBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphDeterminantBlock;
    case "FlowGraphInvertMatrixBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphInvertMatrixBlock;
    case "FlowGraphMatrixMultiplicationBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphMatrixMultiplicationBlock;
    case "FlowGraphBranchBlock":
      return async () => (await import("./flowGraphBranchBlock-OKRLIEWA.js")).FlowGraphBranchBlock;
    case "FlowGraphSetDelayBlock":
      return async () => (await import("./flowGraphSetDelayBlock-GV3PJ54R.js")).FlowGraphSetDelayBlock;
    case "FlowGraphCancelDelayBlock":
      return async () => (await import("./flowGraphCancelDelayBlock-H3DMIL74.js")).FlowGraphCancelDelayBlock;
    case "FlowGraphCallCounterBlock":
      return async () => (await import("./flowGraphCounterBlock-TBOYCWDV.js")).FlowGraphCallCounterBlock;
    case "FlowGraphDebounceBlock":
      return async () => (await import("./flowGraphDebounceBlock-TTZ2FUA4.js")).FlowGraphDebounceBlock;
    case "FlowGraphThrottleBlock":
      return async () => (await import("./flowGraphThrottleBlock-3QWQCBJP.js")).FlowGraphThrottleBlock;
    case "FlowGraphDoNBlock":
      return async () => (await import("./flowGraphDoNBlock-X5PHDOAO.js")).FlowGraphDoNBlock;
    case "FlowGraphFlipFlopBlock":
      return async () => (await import("./flowGraphFlipFlopBlock-5K7D2HSH.js")).FlowGraphFlipFlopBlock;
    case "FlowGraphForLoopBlock":
      return async () => (await import("./flowGraphForLoopBlock-5NIAI6U5.js")).FlowGraphForLoopBlock;
    case "FlowGraphMultiGateBlock":
      return async () => (await import("./flowGraphMultiGateBlock-NEZRXHGN.js")).FlowGraphMultiGateBlock;
    case "FlowGraphSequenceBlock":
      return async () => (await import("./flowGraphSequenceBlock-FYVHRGUV.js")).FlowGraphSequenceBlock;
    case "FlowGraphSwitchBlock":
      return async () => (await import("./flowGraphSwitchBlock-3O7BT5ON.js")).FlowGraphSwitchBlock;
    case "FlowGraphWaitAllBlock":
      return async () => (await import("./flowGraphWaitAllBlock-OHZU5PNG.js")).FlowGraphWaitAllBlock;
    case "FlowGraphWhileLoopBlock":
      return async () => (await import("./flowGraphWhileLoopBlock-RAN6SIBF.js")).FlowGraphWhileLoopBlock;
    case "FlowGraphConsoleLogBlock":
      return async () => (await import("./flowGraphConsoleLogBlock-HVC4LMP7.js")).FlowGraphConsoleLogBlock;
    case "FlowGraphConditionalBlock":
      return async () => (await import("./flowGraphConditionalDataBlock-MD2FSFH2.js")).FlowGraphConditionalDataBlock;
    case "FlowGraphConstantBlock":
      return async () => (await import("./flowGraphConstantBlock-NLOXZZ7E.js")).FlowGraphConstantBlock;
    case "FlowGraphTransformCoordinatesSystemBlock":
      return async () => (await import("./flowGraphTransformCoordinatesSystemBlock-LJ5RGZET.js")).FlowGraphTransformCoordinatesSystemBlock;
    case "FlowGraphGetAssetBlock":
      return async () => (await import("./flowGraphGetAssetBlock-U4NURHUJ.js")).FlowGraphGetAssetBlock;
    case "FlowGraphGetPropertyBlock":
      return async () => (await import("./flowGraphGetPropertyBlock-WQBB7DXY.js")).FlowGraphGetPropertyBlock;
    case "FlowGraphSetPropertyBlock":
      return async () => (await import("./flowGraphSetPropertyBlock-DJBUDGRN.js")).FlowGraphSetPropertyBlock;
    case "FlowGraphGetVariableBlock":
      return async () => (await import("./flowGraphGetVariableBlock-PXH354SI.js")).FlowGraphGetVariableBlock;
    case "FlowGraphSetVariableBlock":
      return async () => (await import("./flowGraphSetVariableBlock-PAKNVWZX.js")).FlowGraphSetVariableBlock;
    case "FlowGraphJsonPointerParserBlock":
      return async () => (await import("./flowGraphJsonPointerParserBlock-ITY723ND.js")).FlowGraphJsonPointerParserBlock;
    case "FlowGraphLeadingZerosBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphLeadingZerosBlock;
    case "FlowGraphTrailingZerosBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphTrailingZerosBlock;
    case "FlowGraphOneBitsCounterBlock":
      return async () => (await import("./flowGraphMathBlocks-6PDLUACZ.js")).FlowGraphOneBitsCounterBlock;
    case "FlowGraphCombineVector2Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphCombineVector2Block;
    case "FlowGraphCombineVector3Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphCombineVector3Block;
    case "FlowGraphCombineVector4Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphCombineVector4Block;
    case "FlowGraphCombineMatrixBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphCombineMatrixBlock;
    case "FlowGraphExtractVector2Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphExtractVector2Block;
    case "FlowGraphExtractVector3Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphExtractVector3Block;
    case "FlowGraphExtractVector4Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphExtractVector4Block;
    case "FlowGraphExtractMatrixBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-2FOTDBE7.js")).FlowGraphExtractMatrixBlock;
    case "FlowGraphTransformVectorBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphTransformBlock;
    case "FlowGraphTransformCoordinatesBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphTransformCoordinatesBlock;
    case "FlowGraphConjugateBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphConjugateBlock;
    case "FlowGraphAngleBetweenBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphAngleBetweenBlock;
    case "FlowGraphQuaternionFromAxisAngleBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphQuaternionFromAxisAngleBlock;
    case "FlowGraphAxisAngleFromQuaternionBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphAxisAngleFromQuaternionBlock;
    case "FlowGraphQuaternionFromDirectionsBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-RVPLNNTH.js")).FlowGraphQuaternionFromDirectionsBlock;
    case "FlowGraphMatrixDecompose":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphMatrixDecomposeBlock;
    case "FlowGraphMatrixCompose":
      return async () => (await import("./flowGraphMatrixMathBlocks-OQNLOZLM.js")).FlowGraphMatrixComposeBlock;
    case "FlowGraphBooleanToFloat":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphBooleanToFloat;
    case "FlowGraphBooleanToInt":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphBooleanToInt;
    case "FlowGraphFloatToBoolean":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphFloatToBoolean;
    case "FlowGraphIntToBoolean":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphIntToBoolean;
    case "FlowGraphIntToFloat":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphIntToFloat;
    case "FlowGraphFloatToInt":
      return async () => (await import("./flowGraphTypeToTypeBlocks-PI22G2QV.js")).FlowGraphFloatToInt;
    case "FlowGraphEasingBlock":
      return async () => (await import("./flowGraphEasingBlock-RWQZXC46.js")).FlowGraphEasingBlock;
    case "FlowGraphBezierCurveEasing":
      return async () => (await import("./flowGraphBezierCurveEasingBlock-J3IMUEVY.js")).FlowGraphBezierCurveEasingBlock;
    case "FlowGraphPointerOverEventBlock":
      return async () => (await import("./flowGraphPointerOverEventBlock-O2RJX7CI.js")).FlowGraphPointerOverEventBlock;
    case "FlowGraphPointerOutEventBlock":
      return async () => (await import("./flowGraphPointerOutEventBlock-OR3ZORUI.js")).FlowGraphPointerOutEventBlock;
    case "FlowGraphContextBlock":
      return async () => (await import("./flowGraphContextBlock-P4FSQ5HG.js")).FlowGraphContextBlock;
    case "FlowGraphArrayIndexBlock":
      return async () => (await import("./flowGraphArrayIndexBlock-72FQDBB3.js")).FlowGraphArrayIndexBlock;
    case "FlowGraphCodeExecutionBlock":
      return async () => (await import("./flowGraphCodeExecutionBlock-HVC5OFVR.js")).FlowGraphCodeExecutionBlock;
    case "FlowGraphIndexOfBlock":
      return async () => (await import("./flowGraphIndexOfBlock-ANCB2QHX.js")).FlowGraphIndexOfBlock;
    case "FlowGraphFunctionReference":
      return async () => (await import("./flowGraphFunctionReferenceBlock-432PJ54I.js")).FlowGraphFunctionReferenceBlock;
    case "FlowGraphDataSwitchBlock":
      return async () => (await import("./flowGraphDataSwitchBlock-A73I3PGY.js")).FlowGraphDataSwitchBlock;
    default:
...
Node.AddNodeConstructor("Light_Type_1", (name5, scene) => {
  return () => new DirectionalLight(name5, Vector3.Zero(), scene);
});
var DirectionalLight = class extends ShadowLight {
   ...
   */
  constructor(name5, direction, scene, dontAddToScene) {
    super(name5, scene, dontAddToScene);
...
Node.AddNodeConstructor("Light_Type_0", (name5, scene) => {
  return () => new PointLight(name5, Vector3.Zero(), scene);
});
var PointLight = class extends ShadowLight {
   ...
   * @param dontAddToScene True to not add the light to the scene
   */
  constructor(name5, position, scene, dontAddToScene) {
    super(name5, scene, dontAddToScene);
...
Node.AddNodeConstructor("Light_Type_4", (name5, scene) => {
  return () => new RectAreaLight(name5, Vector3.Zero(), 1, 1, scene);
});
var RectAreaLight = class _RectAreaLight extends AreaLight {
   ...
   * @param dontAddToScene True to not add the light to the scene
   */
  constructor(name5, position, width, height, scene, dontAddToScene) {
    super(name5, position, scene, dontAddToScene);
...
var MorphTarget = class _MorphTarget {
   ...
   */
  constructor(name5, influence = 0, scene = null) {
    this.name = name5;
    this.animations = [];
   ...
   * @returns a new MorphTarget
   */
  static FromMesh(mesh, name5, influence) {
    if (!name5) {
      name5 = mesh.name;
    }
    const result = new _MorphTarget(name5, influence, mesh.getScene());
...
var MorphTargetManager = class _MorphTargetManager {
   ...
   * @returns the requested target
   */
  getTargetByName(name5) {
    for (const target of this._targets) {
      if (target.name === name5) {
        return target;
      }
    }
    return null;
...
var shader = `precision highp float;varying vec2 vPosition;varying vec4 vColor;
#ifdef DEPTH_RENDER
      ...
      const effect = scene.getEngine().createEffect("gaussianSplatting", {
        ...
        extraInitializationsAsync: async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./gaussianSplatting.fragment-QV7SSBZG.js"), import("./gaussianSplatting.vertex-QHQKMDR2.js")]);
          } else {
            await Promise.all([import("./gaussianSplatting.fragment-CWYNK7VQ.js"), import("./gaussianSplatting.vertex-JBVRWBIH.js")]);
          }
        }
      }, engine);
...
var DracoDecoder = class _DracoDecoder extends DracoCodec {
   ...
   */
  async decodeMeshToGeometryAsync(name5, scene, data, attributes) {
    const meshData = await this.decodeMeshToMeshDataAsync(data, attributes);
    const geometry = new Geometry(name5, scene);
    if (meshData.indices) {
  ...
  /** @internal */
  async _decodeMeshToGeometryForGltfAsync(name5, scene, data, attributes, gltfNormalizedOverride, boundingInfo) {
...
var GaussianSplattingPartProxyMesh = class extends Mesh {
  /**
...
var PointsCloudSystem = class {
   ...
   */
  constructor(name5, pointSize, scene, options) {
...
//# sourceMappingURL=chunk-YCOCDVPX.js.map
