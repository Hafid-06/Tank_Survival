    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-UJ7AX7C5.js"), import("./pbr.fragment-Y7ZSFJ62.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-74FM3FHF.js"), import("./pbr.fragment-GI6JKKEX.js")]);
        }
...
//# sourceMappingURL=chunk-T2Z76CJL.js.map
